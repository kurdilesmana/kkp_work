			...
			<form id="form">
				<div class="modal-body">
					...
					<div class="form-group">
						...
						<div class="invalid-feedback" name="nama_karyawan-message"></div>
					</div>
					<div class="form-group">
						<input type="text" class="form-control" id="bagian_karyawan" name="bagian_karyawan" placeholder="Bagian Karyawan" value="<?= set_value('bagian_karyawan') ?>">
						<div class="invalid-feedback" name="bagian_karyawan-message"></div>
					</div>
				</div>
