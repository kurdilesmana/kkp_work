			...
			<form id="form">
				<div class="modal-body">
					...
					<div class="form-group">
						<select class="form-control select2-hidden-accessible col-sm" id="menu_id" name="menu_id" style="width: 100%;" tabindex="-1" aria-hidden="true" required></select>
						<div class="invalid-feedback" name="menu_id-message"></div>
					</div>
					<div class="form-group">
						<select class="form-control select2-hidden-accessible col-sm" id="role_id" name="role_id" style="width: 100%;" tabindex="-1" aria-hidden="true" required></select>
